...
public abstract class JudgeAbstract {
    ...
    public abstract GameObjectID createTower(int teamID, int towerType, GameObjectID path, GameObjectID lane, int index, int rowNumber, int colNumber) throws DotaExceptionBase;

    // Powerups
    public abstract void purchaseAttackersPowerup(int teamID, int powerupType)
            throws DotaExceptionBase;

    public abstract void purchaseTowerPowerup(int teamID, GameObjectID towerID, int powerupType) throws DotaExceptionBase;
    ...
    // Controllerpublic abstract void next50milis();
